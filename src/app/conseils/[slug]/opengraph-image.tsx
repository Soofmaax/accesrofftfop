...
export default function OpenGraphImage({ params }: PageProps) {
  ...
  const title = article ? article.title : 'Conseils';
  const subtitle = article ? article.readingTime : 'Guides pratiques pour réussir votre projet.';
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          >
            ...
            <span style={{ color: 'rgba(148,163,184,0.95)' }}>Conseil</span>
          </div>
